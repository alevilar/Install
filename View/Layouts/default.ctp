...
<html>
    <head>
        ...
        echo $this->Html->css(array(
            '/install/lib/bootstrap/css/bootstrap.min',
            '/install/lib/bootstrap/css/bootstrap-theme.min',
            '/install/css/ristorantino/style',
            '/install/lib/bootstrap_datetimepicker/css/bootstrap-datetimepicker.min',
        ));
